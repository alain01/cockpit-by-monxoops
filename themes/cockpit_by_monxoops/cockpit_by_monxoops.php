...
/**
 * Class XoopsGuicockpit_by_monxoops
 */
class XoopsGuicockpit_by_monxoops extends XoopsSystemGui
{
    /**
     *
     */
    ...
    */
    ...
    public function header()
    {
        ...
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/js/styleswitch.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/js/formenu.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/js/menu.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/js/tooltip.js');
//        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/js/tabs.jquery.tools.min.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/js/tabs.js');
        $xoTheme->addScript(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/js/tabs.slideshow.js');
...
//        $xoTheme->addStylesheet('https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css');
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/css/style.css');
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/css/mx-theme.css');
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/css/mx-theme-adminlte.css');
		
		
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/css/dark.css', array('title' => 'dark', 'media' => 'screen'));
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/css/silver.css', array('title' => 'silver', 'media' => 'screen'));
        $xoTheme->addStylesheet(XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/css/orange.css', array('title' => 'orange', 'media' => 'screen'));
...
//        $tpl->assign('allow_call_time_pass_reference', ini_get('allow_call_time_pass_reference') ? 'On' : 'Off');
        ...
        $menu[1]['absolute'] = 1;
        $menu[1]['icon']     = XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/images/xoops.png';
        $menu[2]['link']     = XOOPS_URL . '/user.php?op=logout';
        $menu[2]['title']    = "<span class='fa fa-sign-out'></span> " . _LOGOUT;
        $menu[2]['absolute'] = 1;
        $menu[2]['icon']     = XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/images/logout.png';
        ...
        $OPT[] = array(
            ...
            'absolute' => 1,
            'icon'     => XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/icons/prefs_small.png');
        $OPT[] = array(
        ...
        $menu[] = array(
            ...
            'absolute' => 1,
            'icon'     => XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/images/xoops.png');
        $menu[] = array(
        ...
        $menu[] = array(
            ...
            'absolute' => 1,
            'icon'     => XOOPS_ADMINTHEME_URL . '/cockpit_by_monxoops/images/tweb.png');
        ...
        if (file_exists($file = XOOPS_ADMINTHEME_PATH . '/cockpit_by_monxoops/language/' . $xoopsConfig['language'] . '/localsupport.php')) {
            $links = include XOOPS_ADMINTHEME_PATH . '/cockpit_by_monxoops/language/' . $xoopsConfig['language'] . '/localsupport.php';
            if (count($links) > 0) {
